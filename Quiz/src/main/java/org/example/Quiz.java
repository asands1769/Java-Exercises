...
public class Quiz {
    ...
    public static void setScorePercentage(double scorePercentage) {
    ...
    public static void startQuiz(){
        ...
        System.out.println("You got " + score + " questions correct out of " + quizQuestions.size() + ".  Your percentage was " + getScorePercentage() + "%.");
